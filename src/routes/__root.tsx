...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Niber-Dealz — Shop SA Direct" },
      { property: "og:description", content: "Verified South African vendors. Direct WhatsApp checkout. No buyer account needed." },
