...
DROP POLICY IF EXISTS "ceo reads store settings" ON public.store_settings;
...
DROP POLICY IF EXISTS "ceo manages discount codes" ON public.discount_codes;
...
DROP POLICY IF EXISTS "ceo reads visitor events" ON public.product_events;
...
DROP POLICY IF EXISTS "ceo manages legacy payments" ON public.payments;
...
DROP POLICY IF EXISTS "ceo reads retired affiliates" ON public.affiliates;
...
DROP POLICY IF EXISTS "ceo reads retired affiliate referrals" ON public.affiliate_referrals;
...
DROP POLICY IF EXISTS "ceo reads retired affiliate points" ON public.affiliate_points_ledger;
...
DROP POLICY IF EXISTS "ceo manages retired affiliate payouts" ON public.affiliate_payouts;
...
DROP POLICY IF EXISTS "ceo manages reports" ON public.reports;
...
DROP POLICY IF EXISTS "ceo reads retired vendor warnings" ON public.vendor_warnings;
