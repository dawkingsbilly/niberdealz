...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Niber-Dealz — South African Marketplace" },
      { property: "og:description", content: "Niber-Dealz is the South African marketplace where verified vendors sell direct to buyers via WhatsApp. No buyer accounts needed." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Niber-Dealz — South African Marketplace" },
      { name: "twitter:description", content: "Niber-Dealz is the South African marketplace where verified vendors sell direct to buyers via WhatsApp. No buyer accounts needed." },
